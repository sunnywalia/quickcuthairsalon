...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
	...
	<div class="clear"></div>
	<div class="service">
			<h2>QUICK CUT STYLE UNISEX SALON</h2>
			<p style="width:80%; margin-left: 8%;">
				QUICK CUT STYLE UNISEX SALON The salon offers a full range of cutting edge salon services and products. They provide scissor, clipper/razor services for men and women, children's services, shampoo/blow-dry, thermal finishing, coloring with "Schwarzkopf", perming waxing and more..
			</p>
			<img src="images/about.jpg">
			<div class="clear"></div>

      <h2>OUR VALUES</h2>
      <h3 class="w3l_header">Our <span>Mission</span></h3>

      <p style="width:80%; margin-left: 8%;">
        MISSION:OUR MISSION STARTS WITH BECOMING THE PREMIER SALON IN DUBAI& EMPLOYER OF CHOICE IN THE BEAUTY SERVICES INDUSTRY, TOWARDS ENSURING THAT OUR TEAM IS ALWAYS AT THE EXPECTATIONS OF OUR VALUABLE CLIENTS PROVIDING THEM SUPERIOR SERVICES WITH THE HIGHEST BEST QUALITY BEAUTY PRODUCTS. WE PROUDLY ARE USING THE BEST WORLD-WIDE BRANDS.
      </p>
      <h3 class="w3l_header">Our <span>Vision</span></h3>

      <p style="width:80%; margin-left: 8%;">
          VISION: To become the premier chain of salons in austelia, then across UAE,and employer of choice in the beauty services.To ensure that our staff are always at the leading edge of the beauty industry. To provide our guests with superior services through our highly qualified staff, and the highest quality beauty products.
      </p>
...
<div class="container-fluid text-center bg-grey">
		...
		<div class="row text-center">
            ...
            $result =mysql_query("select * from content limit 3");
